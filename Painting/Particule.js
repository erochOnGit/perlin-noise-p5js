function Particule() {
  ...
  this.show = function() {
    let rdmR = noise(this.position.x) * 60;
    let rdmG = noise(this.position.x) * 800;
    let rdmB = noise(this.position.x) * 800;
    let rdmA = noise(this.position.x) * 6;
  ...
  this.showCircle = function(color, opacity) {
    let rdmR = noise(this.position.x) * color;
    let rdmG = noise(this.position.x) * 200;
    let rdmB = noise(this.position.x) * 200;
    let rdmA = noise(this.position.x) * opacity;
